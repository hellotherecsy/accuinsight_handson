...
# Batch Pipeline 튜토리얼
  ...
  ## 튜토리얼 내용
   ...
   >
   > 실제 kaggle의 Competition중 "House Prices: Advanced Regression Techniques" 의 데이터를 활용하고 NoteBooks중 [Serigne](https://www.kaggle.com/serigne)의 [Stacked Regressions : Top 4% on LeaderBoard](https://www.kaggle.com/serigne/stacked-regressions-top-4-on-leaderboard) 를 참고함
   >
   > 
...
1. 데이터 불러오기 텝에서 `ICOS불러오기 노드를` 드래그 & 드랍해서 캔버스에 옮긴다.
2. ICOS불러오기 노드를 클릭한 후 file속성의 `팝업열기` 버튼을 클릭한다.
